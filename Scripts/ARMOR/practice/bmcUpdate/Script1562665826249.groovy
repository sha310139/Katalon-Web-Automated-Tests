...
smartWaitAndClick(findTestObject('Object Repository/Page_ARMOR/a_Venus-Rack'), GlobalVariable.G_Small_Timeout)

smartWaitAndClick(findTestObject('Object Repository/Page_ARMOR/a_CPNODE'), GlobalVariable.G_Small_Timeout)

for (int i = 0 ; i < 4 ; i++) {
	WebUI.scrollToElement(findTestObject('Object Repository/Page_ARMOR/input_PAVR1001_btSelectItem'), GlobalVariable.G_Small_Timeout)
	
	// check current version
	version = WebUI.getText(findTestObject('Page_ARMOR/td_BMC_Version'))
	
	smartWaitAndClick(findTestObject('Object Repository/Page_ARMOR/input_PAVR1001_btSelectItem'), GlobalVariable.G_Small_Timeout)

	WebUI.scrollToElement(findTestObject('Object Repository/Page_ARMOR/button_Update BMC'), GlobalVariable.G_Small_Timeout)
	
	smartWaitAndClick(findTestObject('Object Repository/Page_ARMOR/button_Update BMC'), GlobalVariable.G_Small_Timeout)
	
	// choose version
	if (version.equals('PA36M001.6')) {
		smartWait(findTestObject('Object Repository/Page_ARMOR/select_AIAQN0111PA36M0016PA36M0015'), GlobalVariable.G_Small_Timeout)
		WebUI.selectOptionByValue(findTestObject('Object Repository/Page_ARMOR/select_AIAQN0111PA36M0016PA36M0015'), '1', true)
		// choose version 15
	} // if
	else {
		smartWait(findTestObject('Object Repository/Page_ARMOR/select_AIAQN0111PA36M0016PA36M0015'), GlobalVariable.G_Small_Timeout)
		WebUI.selectOptionByValue(findTestObject('Object Repository/Page_ARMOR/select_AIAQN0111PA36M0016PA36M0015'), '13', true)
		// choose version 16
	} // else
	...
	if (i % 2 == 0) {  // first & third -> uncheck force_update
		...
		WebUI.uncheck(findTestObject('Object Repository/Page_ARMOR/input_Force update_force-update'))
		WebUI.verifyElementNotChecked(findTestObject('Object Repository/Page_ARMOR/input_Force update_force-update'), GlobalVariable.G_Small_Timeout)
	} // if
	...
	if (i < 2) {	  // first & second -> preserve
		smartWaitAndClick(findTestObject('Object Repository/Page_ARMOR/input_Preserve configurations_keep-bmc-config'), GlobalVariable.G_Small_Timeout)
	} // if
	else {			  // third & fourth -> overwrite all
		smartWaitAndClick(findTestObject('Object Repository/Page_ARMOR/input_Overwrite all configurations_keep-bmc-config'), GlobalVariable.G_Small_Timeout)
	} // else
	...
	WebUI.delay(3)
	if (!WebUI.getText(findTestObject('Page_ARMOR/messege')).equals('Update BMC Firmware Complete') ) {
